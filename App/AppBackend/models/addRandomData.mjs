...
export async function addRandomData() {
    try {
      ...
      for (let i = 0; i < 10; i++) {
        const photodata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/restphoto.jpg');
        ...
        if (type=== 'Breakfast & Brunch'){
          ...
          await Restaurant.create({
            ...
            Opens_on: faker.date.between(startTime1,endTime1).toLocaleTimeString([],{hour:'2-digit',minute:'2-digit'}),
            Closes_at: faker.date.between(startTime2,endTime2).toLocaleTimeString([],{hour:'2-digit',minute:'2-digit'}),
            Image: photoblob,
      ...
      const fooddata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/menu.jpg');
      const foodblob = new Blob([fooddata], {type: 'image/jpg'});
      const drinksdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/drinks.jpg');
      const drinksblob = new Blob([drinksdata], {type: 'image/jpg'});
      const winedata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/wines.jpg');
      ...
      for (let i = 0; i < 10; i++) {
        ...
        if (restaurant.Restaurant_Type === 'Italian' || restaurant.Restaurant_Type==='Mexican' || restaurant.Restaurant_Type==='Greek' || restaurant.Restaurant_Type==='Burgers' || restaurant.Restaurant_Type==='Steakhouse' || restaurant.Restaurant_Type==='Indian' || restaurant.Restaurant_Type==='Chinese' || restaurant.Restaurant_Type==='Sushi' || restaurant.Restaurant_Type==='Fish'){
          ...
          await Menu.create({
            ...
            Name: nametypes[0],
            Type: nametypes[0],
            Active_from: faker.date.between(startTime1,endTime1).toLocaleTimeString([],{hour:'2-digit',minute:'2-digit'}),
      ...
      for (let i = 0; i < 30; i++) {
        ...
        if (menu.Type === nametypes[0] && restaurant.Restaurant_Type!=='Breakfast & Brunch'){
            ...
            const min = 15.00;
            const max= 18.00;
            const palomadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/paloma.jpg');
            const paloma = new Blob([palomadata], {type: 'image/jpg'});
            const mojitodata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/mojito.jpg');
            const mojito= new Blob([mojitodata], {type: 'image/jpg'});
            const margarittadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/margarita.jpg');
            const margaritta = new Blob([margarittadata], {type: 'image/jpg'});
            const cosmodata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/cosmopolitan.jpg');
            const cosmopolitan = new Blob([cosmodata], {type: 'image/jpg'});
            const whitedata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/whitewine.jpg');
            const whitewine = new Blob([whitedata], {type: 'image/jpg'});
            const reddata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/redwine.jpg');
        ...
        if (menu.Type === nametypes[0] && restaurant.Restaurant_Type==='Breakfast & Brunch'){
          ...
          const min = 4.00;
          const max= 7.00;
          const carameldata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/caramel.jpg');
          const caramel = new Blob([carameldata], {type: 'image/jpg'});
          const matchadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/matcha.jpg');
          const matcha = new Blob([matchadata], {type: 'image/jpg'});
          const orangedata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/orange.jpg');
          const orangejuice = new Blob([orangedata], {type: 'image/jpg'});
          const berrydata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/berry.jpg');
          const berryblast = new Blob([berrydata], {type: 'image/jpg'});
          const mochadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/mocha.jpg');
          const mocha = new Blob([mochadata], {type: 'image/jpg'});
          const herbaldata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/herbal.jpg');
        ...
        if (menu.Type === nametypes[3]){
            ...
            const min = 20.50;
            const max = 27.00;
            const paragkawdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/white.jpg');
            const paragkaw = new Blob([paragkawdata], {type: 'image/jpg'});
            const paragkardata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/red.jpg');
            const paragkar = new Blob([paragkardata], {type: 'image/jpg'});
            const notosdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/white.jpg');
            const notos = new Blob([notosdata], {type: 'image/jpg'});
            const chardata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/sparkly.jpg');
            const char = new Blob([chardata], {type: 'image/jpg'});
            const malagouziadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/red.jpg');
        ...
        if (menu.Type === nametypes[1]){
            ...
            const min= 11.50;
            const max = 15.00;
            const omelettedata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/omelette.jpg');
            const omelette = new Blob([omelettedata], {type: 'image/jpg'});
            const pancakesdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/pancakes.jpg');
            const pancakes = new Blob([pancakesdata], {type: 'image/jpg'});
            const avotoastdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/avotoast.jpg');
            const avotoast = new Blob([avotoastdata], {type: 'image/jpg'});
            const burittodata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/buritto.jpg');
            const buritto = new Blob([burittodata], {type: 'image/jpg'});
            const granoladata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/granola.jpg');
        ...
        if (menu.Type === nametypes[2] && restaurant.Restaurant_Type==='Italian'){
            ...
            const min = 14.50;
            const max = 18.99;
            const carbonaradata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/carbonara.jpg');
            const carbonara = new Blob([carbonaradata], {type: 'image/jpg'});
            const pizzadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/pizza.jpg');
            const pizza = new Blob([pizzadata], {type: 'image/jpg'});
            const chickendata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/chicken.jpg');
            const chicken = new Blob([chickendata], {type: 'image/jpg'});
            const risottodata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/risotto.jpg');
        ...
        if (menu.Type=== nametypes[2] && restaurant.Restaurant_Type==='Mexican'){
            ...
            const min = 13.50;
            const max= 17.99;
            const enchiladasdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/enchiladas.jpg');
            const enchiladas = new Blob([enchiladasdata], {type: 'image/jpg'});
            const tacosdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/tacos.jpg');
            const tacos = new Blob([tacosdata], {type: 'image/jpg'});
            const chilesdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/chiles.jpg');
            const chiles = new Blob([chilesdata], {type: 'image/jpg'});
            const moledata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/mole.jpg');
        ...
        if (menu.Type=== nametypes[2] && restaurant.Restaurant_Type==='Greek'){
          ...
          const min = 14.50;
          const max= 17.99;
          const mousakadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/mousaka.jpg');
          const mousaka = new Blob([mousakadata], {type: 'image/jpg'});
          const souvlakidata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/souvlaki.jpg');
          const souvlaki = new Blob([souvlakidata], {type: 'image/jpg'});
          const spanakopitadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/spanakopita.jpg');
          const spanakopita = new Blob([spanakopitadata], {type: 'image/jpg'});
          const dolmadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/dolma.jpg');
        ...
        if (menu.Type=== nametypes[2] && restaurant.Restaurant_Type==='Burgers'){
          ...
          const min = 14.50;
          const max= 17.99;
          const cheesedata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/cheese.jpg');
          const cheese = new Blob([cheesedata], {type: 'image/jpg'});
          const bbqdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/bbq.jpg');
          const bbq = new Blob([bbqdata], {type: 'image/jpg'});
          const mushroomdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/mushroom.jpg');
          const mushroom = new Blob([mushroomdata], {type: 'image/jpg'});
          const spicydata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/spicy.jpg');
        ...
        if (menu.Type=== nametypes[2] && restaurant.Restaurant_Type==='Sushi'){
          ...
          const min = 15.50;
          const max= 18.99;
          const californiadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/california.jpg');
          const california = new Blob([californiadata], {type: 'image/jpg'});
          const nigiridata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/nigiri.jpg');
          const nigiri = new Blob([nigiridata], {type: 'image/jpg'});
          const tunadata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/tuna.jpg');
          const tuna = new Blob([tunadata], {type: 'image/jpg'});
          const dragondata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/dragon.jpg');
        ...
        if (menu.Type=== nametypes[2] && restaurant.Restaurant_Type==='Fish'){
          ...
          const min = 15.50;
          const max= 17.99;
          const salmondata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/salmon.jpg');
          const salmon = new Blob([salmondata], {type: 'image/jpg'});
          const fishtacodata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/fishtaco.jpg');
          const fishtaco = new Blob([fishtacodata], {type: 'image/jpg'});
          const mahidata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/mahi.jpg');
          const mahi = new Blob([mahidata], {type: 'image/jpg'});
          const shrimpdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/shrimp.jpg');
        ...
        if (menu.Type=== nametypes[2] && restaurant.Restaurant_Type==='Indian'){
          ...
          const min = 15.50;
          const max= 17.99;
          const butterdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/butter.jpg');
          const butter = new Blob([butterdata], {type: 'image/jpg'});
          const biryanidata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/biryani.jpg');
          const biryani = new Blob([biryanidata], {type: 'image/jpg'});
          const palakdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/palak.jpg');
          const palak = new Blob([palakdata], {type: 'image/jpg'});
          const masaladata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/masala.jpg');
        ...
        if (menu.Type=== nametypes[2] && restaurant.Restaurant_Type==='Chinese'){
          ...
          const min = 15.50;
          const max= 18.99;
          const sourdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/sour.jpg');
          const sour = new Blob([sourdata], {type: 'image/jpg'});
          const paodata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/pao.jpg');
          const pao = new Blob([paodata], {type: 'image/jpg'});
          const beefdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/beef.jpg');
          const beef = new Blob([beefdata], {type: 'image/jpg'});
          const meindata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/mein.jpg');
        ...
        if (menu.Type=== nametypes[2] && restaurant.Restaurant_Type==='Steakhouse'){
          ...
          const min = 19.50;
          const max= 24.50;
          const ribeyedata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/ribeye.jpg');
          const ribeye = new Blob([ribeyedata], {type: 'image/jpg'});
          const filetdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/filet.jpg');
          const filet = new Blob([filetdata], {type: 'image/jpg'});
          const tbonedata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/tbone.jpg');
          const tbone = new Blob([tbonedata], {type: 'image/jpg'});
          const yorkdata=fs.readFileSync('C:/Users/M.Karadeloglou/Documents/University/Semester 8/Web Development/Project/york.jpg');
